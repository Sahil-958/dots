...
if sudo -u sawhill git -C /home/sawhill/dots diff --quiet package_list_control/pkglist_forgien_hooks_generated.txt package_list_control/pkglist_hooks_generated.txt; then
    echo "No changes to commit."
else
    # Add, commit, and push changes
    sudo -u sawhill git -C /home/sawhill/dots add package_list_control/pkglist_forgien_hooks_generated.txt package_list_control/pkglist_hooks_generated.txt
