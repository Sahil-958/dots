...
/*#define COLOR mix({{colors.primary_container.default.hex}}, {{colors.secondary_container.default.hex}}, clamp(pos / GRADIENT_SCALE, 0, 1))*/
#define COLOR mix({{colors.secondary.default.hex}}, {{colors.secondary_container.default.hex}}, clamp(pos / GRADIENT_SCALE, 0, 1))
...
#define ANTI_ALIAS 0
/* outline color */
#define OUTLINE {{colors.background.default.hex}}
